const CACHE_NAME='kgba-kid-jam-v1.0.0';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/maskable-512.png','./screenshots/screenshot-wide.png','./screenshots/screenshot-narrow.png'];
