...
`https://github.com/KernelGreyBeret/KGBArcade/security/advisories/new`
...
Good-faith reports may cover the public website, browser games, game packages, service workers, manifests, deployment configuration, and shared runtime or engine code.
